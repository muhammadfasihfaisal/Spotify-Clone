  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <p className='bg-black py-1 px3 rounded-full text-[15px] cursor-s'>Install App</p>
...
<div className='flex items-center gap-2 mt-4'>
    ...
    <p className='bg-black px-4py-1 rounded-full cursor-pointer'>Music</p>
    <p className='bg-black px-4py-1 rounded-full cursor-pointer'>Podcasts</p>
